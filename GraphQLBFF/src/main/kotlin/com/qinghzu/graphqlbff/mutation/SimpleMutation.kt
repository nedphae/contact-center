...
class SimpleMutation : Mutation {
    ...
    @GraphQLDescription("add list to a list and return resulting list")
    fun addListToList(entryList: List<Long>): MutableList<String> {
        data.addAll(entryList.map(Long::toString))
        return data
    }
}

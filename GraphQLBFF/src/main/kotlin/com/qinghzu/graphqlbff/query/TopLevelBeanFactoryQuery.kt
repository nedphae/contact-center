...
class TopLevelBeanFactoryQuery : Query, BeanFactoryAware {
    ...
    fun topLevelBeanFactory(topLevelValue: String): SecondLevelBeanFactoryQuery = beanFactory.getBean(
        SecondLevelBeanFactoryQuery::class.java, topLevelValue)
}
...
constructor(internal val topLevelValue: String) : BeanFactoryAware {
    ...
    fun secondLevel(secondLevelValue: String): ThirdLevelBeanFactoryQuery = beanFactory.getBean(
        ThirdLevelBeanFactoryQuery::class.java, topLevelValue, secondLevelValue)
}

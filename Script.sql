...
CREATE INDEX shunt_ui_config_shunt_id ON staffadmin.shunt_ui_config USING btree (shunt_id);
CREATE INDEX shunt_ui_config_organization_id_idx ON staffadmin.shunt_ui_config USING btree (organization_id);
...
CREATE UNIQUE INDEX bot_config_bot_id_idx ON bot.bot_config USING btree (bot_id);
CREATE INDEX bot_config_knowledge_base_id_idx ON bot.bot_config USING btree (knowledge_base_id);
CREATE INDEX bot_config_organization_id_idx ON bot.bot_config USING btree (organization_id);
...
CREATE INDEX knowledge_base_organization_id_idx ON bot.knowledge_base USING btree (organization_id);
...
CREATE INDEX topic_category_organization_id_idx ON bot.topic_category USING btree (organization_id);
CREATE INDEX topic_category_pid_idx ON bot.topic_category USING btree (pid);
...
CREATE INDEX customer_organization_id_idx ON dispathcer.customer USING btree (organization_id);
CREATE INDEX customer_uid_idx ON dispathcer.customer USING btree (uid);
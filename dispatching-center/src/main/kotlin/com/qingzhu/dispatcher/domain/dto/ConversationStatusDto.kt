...
data class ConversationViewDto @Default constructor(
    ...
    constructor(organizationId: Int, userId: Long, shuntId: Long, queue: Long?) : this(
        null, organizationId,
        null, userId, shuntId, null, null, null, queue
    )
}

@Mapper(componentModel = "default", unmappedTargetPolicy = ReportingPolicy.IGNORE)
interface ConversationStatusAndViewMapper {
    @Mapping(source = "fromShuntId", target = "shuntId")
